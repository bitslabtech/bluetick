            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute bottom-20 right-0 w-[350px] sm:w-[400px] h-[550px] max-h-[80vh] bg-white dark:bg-zinc-950 rounded-2xl shadow-2xl shadow-indigo-500/20 border border-slate-200 dark:border-white/10 flex flex-col overflow-hidden"
                    >
                        {/* Header */}
