            ...
            <header className="flex items-center justify-between border-b border-slate-200 dark:border-surface-dark px-4 md:px-4 md:px-6 py-4 bg-white dark:bg-background-dark shrink-0 transition-colors duration-300">
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="flex items-center justify-center size-10 rounded-xl bg-slate-100 dark:bg-surface-dark text-slate-600 dark:text-white hover:bg-slate-200 dark:hover:bg-[#2f455a] transition-colors"
                    >
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-xl font-bold">AI Token Usage History</h1>
                        </div>
                        <p className="text-slate-500 dark:text-slate-400 text-xs mt-0.5">Real-time analytics of your AI token consumption</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center gap-2 h-9 px-4 bg-slate-100 dark:bg-surface-dark hover:bg-slate-200 dark:hover:bg-[#2f455a] text-slate-700 dark:text-white rounded-xl text-sm font-medium transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 h-9 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-bold transition-colors shadow-lg shadow-indigo-500/20"
                    >
                ...
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    {!loading && isLow && (
                        <motion.div
                            ...
                            className="flex items-center gap-4 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-500/30 rounded-2xl"
                        >
                            ...
                            <button
                                onClick={() => navigate('/store')}
                                className="shrink-0 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-sm font-bold rounded-xl transition-colors"
                            >
                                Buy More Tokens
                            </button>
                        </motion.div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center bg-white dark:bg-surface-dark rounded-xl p-1 border border-slate-200 dark:border-[#2f455a]">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        {loading ? (
                            ...
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0 }}
                                ...
                                <p className={`text-3xl font-black mb-1 ${isLow ? 'text-amber-500' : 'text-slate-900 dark:text-white'}`}>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
                        ...
                        {/* Low balance CTA */}
                        {!loading && isLow && (
                            <div className="p-4 border-t border-slate-100 dark:border-[#2f455a] bg-indigo-50 dark:bg-indigo-900/10 flex items-center justify-between">
