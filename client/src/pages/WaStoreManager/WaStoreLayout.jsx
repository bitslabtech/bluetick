...
export default function WaStoreLayout() {
    ...
    if (loading) return (
        <div className="flex flex-col gap-6 w-full max-w-[1700px] mx-auto px-2 md:px-6 xl:px-10 pb-7 sm:pb-20 mt-6 animate-pulse">
            {/* Top Header Skeleton */}
            <div className="bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden shadow-sm h-48 md:h-64 flex flex-col justify-end p-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-64 shrink-0 space-y-3">
                    {[1, 2, 3, 4, 5].map((i) => (
                        <div key={i} className="h-11 w-full bg-slate-100 dark:bg-slate-800/50 rounded-xl"></div>
                    ))}
                </div>
                
                {/* Content Skeleton */}
                <div className="flex-1 space-y-6">
                    <div className="h-24 w-full bg-slate-100 dark:bg-slate-800/50 rounded-2xl"></div>
                    <div className="h-96 w-full bg-slate-100 dark:bg-slate-800/50 rounded-2xl p-6 space-y-5">
                        <div className="h-8 w-1/4 bg-slate-200 dark:bg-slate-700 rounded-lg"></div>
                        <div className="space-y-3">
                            <div className="h-5 w-full bg-slate-200 dark:bg-slate-700 rounded-lg"></div>
                            <div className="h-5 w-5/6 bg-slate-200 dark:bg-slate-700 rounded-lg"></div>
                            <div className="h-5 w-2/3 bg-slate-200 dark:bg-slate-700 rounded-lg"></div>
                        </div>
                    </div>
                </div>
            </div>
