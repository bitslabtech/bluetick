                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="itemType" value={formData.itemType} onChange={handleChange} required className="input-field">
                                ...
                                <option value="team_members">Team Member Seats (validity selectable)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                                Resource Amount {isTeamMembers && <span className="ml-1 text-xs text-slate-400">(seats per pack)</span>}
                            </label>
                            ...
                            <p className="text-[10px] text-slate-500 mt-1">{isTeamMembers ? 'Seats added per unit purchased.' : 'Quantity added to balance.'}</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                                Price {isTeamMembers && <span className="ml-1 text-xs text-slate-400">(per seat)</span>}
                            </label>
                            ...
                            {isTeamMembers && <p className="text-[10px] text-violet-500 mt-1">Price per seat · User selects quantity at checkout</p>}
                        </div>
                        <div>
                        ...
                        {isTeamMembers && (
                            <div className="md:col-span-3">
                                ...
                                <p className="text-[10px] text-slate-500 mt-1.5">How long purchased seats remain active from date of purchase.</p>
                            </div>
                        )}
                    </div>
