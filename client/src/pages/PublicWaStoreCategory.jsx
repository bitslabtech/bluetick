                ...
                <div className="flex flex-row items-center justify-between gap-2 sm:gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <select 
                            ...
                            className="bg-transparent text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-zinc-600 outline-none cursor-pointer py-1"
                        >
                                        ...
                                        <div className={`p-3 md:p-4 flex flex-col flex-1 ${theme.cardBodyStyle}`}>
                                            ...
                                            <div className="mt-auto">
                                                ...
                                                <button 
                                                    ...
                                                    disabled={preventAdd}
                                                    className={`w-full py-2 md:py-2.5 text-[12px] md:text-sm font-semibold rounded-lg flex items-center justify-center gap-1.5 md:gap-2 transition-all ${preventAdd ? 'bg-gray-100 dark:bg-zinc-800 text-gray-400 dark:text-zinc-500 cursor-not-allowed' : theme.buttonStyle}`}
                                                >
                                        ...
                                        {cart.map(item => (
                                            <div key={item.cartItemId || item.id} className="flex gap-4 items-start">
                                                ...
                                                <div className="flex-1 min-w-0 pt-1">
                                                    ...
                                                    <div className={`font-medium text-sm ${theme.textMuted} mt-1`}>{getCurrencySymbol(store.currency)}{getItemPrice(item).toFixed(2)}</div>
                                                    <div className="flex items-center justify-between gap-3 mt-3">
                                                        ...
                                                        <div className={`font-bold text-sm ${theme.text}`}>
                                                            {getCurrencySymbol(store.currency)}{(getItemPrice(item) * item.qty).toFixed(2)}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
