        ...
        <div className="flex flex-col h-full bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display transition-colors duration-300 overflow-hidden fade-in">
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-4 md:p-6 scroll-smooth">
                {loading ? (
                        ...
                        {filteredCampaigns.map((campaign) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row items-center gap-6">
                                    {/* Icon & Status */}
                                    <div className="flex items-center justify-between w-full md:w-auto md:flex-col md:items-start md:gap-3 shrink-0 min-w-[120px] max-w-full">
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center p-4 md:p-8 border-2 border-dashed border-slate-200 dark:border-white/5 rounded-2xl bg-slate-50 dark:bg-surface-dark/30">
