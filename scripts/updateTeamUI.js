...
const filePath = path.join(__dirname, '../client/src/pages/Team.jsx');
...
content = content.replace(
    ...
    PieChart, Activity, ShieldCheck, Mail, Zap, Smartphone, Globe, Lock, CreditCard, Box, Settings
} from 'lucide-react';`
);

// 2. Replace everything after 'if (liveSubUser) {' block
const marker = '    // Reuseable Policy Form Component for Invite/Edit';
...
const newUI = `    // Reuseable Policy Form Component for Invite/Edit
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className="bg-slate-900 dark:bg-black border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="space-y-8">
                            ...
                            {/* Privacy Controls */}
                            <div>
                                <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Customer Privacy</label>
    ...
    return (
        <div className="p-4 sm:p-8 pb-32 max-w-[1400px] mx-auto min-h-screen">
                        ...
                        <div className="relative z-10 flex flex-col xl:flex-row gap-10 justify-between items-start xl:items-center">
                            ...
                            <div className="max-w-xl">
                                ...
                                <button
                                    ...
                                    className={\`mt-8 px-8 py-4 rounded-2xl font-black transition-all flex items-center justify-center gap-3 whitespace-nowrap \${
                                        isLimitReached 
                            ...
                            <div className="w-full xl:w-auto grid grid-cols-1 sm:grid-cols-3 gap-4 shrink-0">
                                ...
                                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-3xl flex flex-col items-center justify-center text-center">
                                    ...
                                    <div className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Capacity</div>
                                </div>
                                ...
                                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-3xl flex flex-col items-center justify-center text-center relative overflow-hidden">
                                    ...
                                    <div className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1 relative z-10">Deployments</div>
                                </div>
...
content = beforeContent + newUI;
fs.writeFileSync(filePath, content);
console.log('Successfully updated Team.jsx');
